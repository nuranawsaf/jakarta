            ...
            <section className='flex justify-between bg-gray-800 px-4 py-3'>
                    ...
                    <div className="relative max-w-xs w-full">
                        ...
                        <input className="block w-full bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg pl-10 pr-4 py-2" placeholder="Search by keywords"/>
                            ...
                            <button onClick={handleClick} className='ml-4 btn-active inline-flex items-center hover:bg-gray-600 bg-gray-700 focus:outline-none focus:shadow-outline rounded-lg shadow pr-3 pl-3'>
                    ...
                    <div className="bg-gray-900 px-4 py-4 sm:text-right xl:mt-20">
