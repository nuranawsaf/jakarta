                        ...
                        <div className="hidden sm:block">
                          ...
                          <template>
                            <div className="mt-3 bg-white xl:border rounded-lg w-48 py-2 shadow-xl">
                              ...
                              <a href="#support" className="block hover:text-white text-gray-800 mt-0 px-4 py-2 hover:bg-indigo-500">Support</a>
                              <a href="#sign-out" className="block hover:text-white text-gray-800 mt-0 px-4 py-2 hover:bg-indigo-500">Sign out</a>
                            </div>
                          </template>
                        </div>
                      </div>
