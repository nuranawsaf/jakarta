            ...
            <section className="bg-gray-800 xl:w-72">
                  <div className="flex justify-between px-4 py-3 xl:hidden">
                    <div className="relative max-w-xs w-full">
                      ...
                      <input className="block w-full bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-900 text-white rounded-lg pl-10 pr-4 py-2" placeholder="Search by keywords"/>
                    </div>
                  ...
                  <form className="xl:block xl:h-full xl:flex xl:flex-col xl:justify-between">
                      ...
                      <div className="px-4 py-4 border-t border-gray-900 lg:w-1/3 xl:border-t-0 xl:w-full">
                        <div className="flex flex-wrap -mx-2">
                          <label className="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
                            ...
                            <select className="mt-1 form-select rounded-lg block w-full text-white shadow bg-gray-600 focus:bg-gray-600">
                              <option>4</option>
                            </select>
                          </label>
                          <label className="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
                            <span className="text-sm font-semibold text-gray-500">Bathrooms</span>
                            <select className="mt-1 form-select block w-full rounded-lg text-white shadow bg-gray-600 focus:bg-gray-600">
                              <option>2</option>
                            </select>
                          </label>
                          <label className="mt-4 block w-full px-2 sm:mt-0 sm:w-1/2 lg:mt-4 lg:w-full">
                            ...
                            <select className="mt-1 form-select block w-full text-white shadow rounded-lg bg-gray-600 focus:bg-gray-600">
                    ...
                    <div className="bg-gray-900 px-4 py-4 sm:text-right xl:mt-28">
